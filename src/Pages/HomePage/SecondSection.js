...
//           color swatch; click the swatch to add it to palette. After selecting a
//           color, experiment with different harmonies by using the dropdown below
//           the color picker.
//         </p>
//       </div>
//       <div
//         className="text-center w-full border rounded-md"
//         data-aos="fade-left">
//         <div className="mt-5">
//           <PopularColor />
//         </div>
